...
DELIMITER //
CREATE PROCEDURE move (IN uid INT)
	DETERMINISTIC
BEGIN
	INSERT INTO users_old (firstname,lastname,email)
	SELECT firstname, lastname, email FROM users WHERE users.id = uid;
...
-- С 6:00 до 12:00 функция должна возвращать фразу "Доброе утро", с 12:00 до
-- 18:00 ФУНКЦИЯ должна возвращать фразу "Добрый день", с 18:00 до 00:00 - "Добрый вечер", с 00:00 до 6:00 - "Доброй ночи".
*/
